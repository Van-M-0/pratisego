...
func FixLen(base netlink.Protocol, n int, byteOrder binary.ByteOrder, maxRecv, maxSend int) *FixLenProtocol {
...
func (p *FixLenProtocol) NewCodec(rw io.ReadWriter) (cc netlink.Codec, err error) {
	codec := &fixlenCodec{
		rw:             rw,
		FixLenProtocol: p,
	}
